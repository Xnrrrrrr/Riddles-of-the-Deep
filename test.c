...
void initializeIslands(Island islands[], int numIslands) {          // function that TAKES island array and numIslands to
    ...
    islands[0].max_food = islands[0].max_treasure;
    ...
    islands[1].max_food = islands[1].max_treasure;
    ...
    islands[2].max_food = islands[2].max_treasure;
    ...
    islands[3].max_food = islands[3].max_treasure;
    ...
    islands[4].food_available = 2 + rand() % 5; // 2 to 6;
    islands[4].max_food = islands[4].max_treasure;
    ...
    islands[5].max_food = islands[5].max_treasure;
    ...
    islands[6].max_food = islands[6].max_treasure;
    ...
    islands[7].max_food = islands[7].max_treasure;
    ...
    islands[8].max_food = islands[8].max_treasure;
    ...
    islands[9].max_food = islands[9].max_treasure;
    ...
    islands[10].max_food = islands[10].max_treasure;
    ...
    islands[11].max_food = islands[11].max_treasure;
    ...
    islands[12].max_food = islands[12].max_treasure;
    ...
    islands[13].max_food = islands[13].max_treasure;
    ...
    islands[14].max_food = islands[14].max_treasure;
    ...
    islands[15].max_food = islands[15].max_treasure;
    ...
    islands[16].max_food = islands[16].max_treasure;
    ...
    islands[17].max_food = islands[17].max_treasure;
    ...
    islands[18].max_food = islands[18].max_treasure;
    ...
    islands[19].max_food = islands[19].max_treasure;
    ...
    islands[20].max_food = islands[20].max_treasure;
    ...
    islands[21].max_food = islands[21].max_treasure;
